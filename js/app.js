...
function renderStaffShell() {
  ...
  mainContent.innerHTML = `
    ${getHeaderHTML()}
    <main class="w-full max-w-6xl mx-auto px-4 sm:px-6 py-6 space-y-6 flex-grow" id="staff-panel"></main>`;
  attachHeaderEvents();

  const cleanup = initStaffDashboard(document.getElementById("staff-panel"), currentUserProfile);
  activeCleanups.push(cleanup);
}

// ==========================================================
// ADMIN SHELL (dengan tab: Rekap Laporan / Kelola Pengguna)
// ==========================================================
function renderAdminShell() {
  ...
  activeCleanups.push(cleanupReports, cleanupUsers);
}
